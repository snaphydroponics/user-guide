...
function GrowBox(props) {
  if (props.lang === 'fil') {
    return (
      ...
      <a href="/working-solution"><i lang="en">working solution</i></a>.
    ...
    <p>Mga kahong yari sa <i lang="en">expanded polystyrene (EPS)</i> na kilala rin sa
      ...
      Setyembre hanggang Enero. Para sa karagdagang impormasyon sumanguni sa <a href="/styrobox">gabay
        sa styrobox</a>.</p>
    ...
    <figure className="figure">
      ...
      <p>Ang styrofoam puncher ay kailangan upang makagawa ng butas sa itaas na bahagi
        ...
        gawing ganitong kasangkapan. Para sa detalye mangyaring sumangguni sa <a href="/styrofoam-puncher">gabay
          sa paggawa ng pambutas ng styrofoam</a>.</p>
    ...
    return (
      ...
      <a href="/en/working-solution">working solution</a>. The grow box also holds
    ...
    <p>Boxes made of expanded polystyrene (EPS) known commonly as “styrofoam box” or
      ...
      <a href="/en/styrobox">the styrobox guide</a>.</p>
    ...
    <figure className="figure">
      ...
      <a href="/en/styrofoam-puncher">guide on making DIY styrofoam puncher</a>.</p>
