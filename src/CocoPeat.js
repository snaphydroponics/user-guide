...
import cocoPeatBrick from './images/coco-peat-brick.jpg';
import cocoCoirDust from './images/coco-coir-dust.jpg';


function CocoPeat(props) {
  if (props.lang === 'fil') {
    return (
...
<figure className="figure">
  <img src={cocoPeatBrick} width="1280" height="853" className="figure-img img-fluid" alt="Tuyo at siksik na brick ng coco peat." />
...
<figure className="figure">
  <img src={cocoPeatBrick} width="1280" height="853" className="figure-img img-fluid" alt="Compressed and dehydrated bricks of coco peat." />
